...
\begin{layer}{180}{0}
    \putnotesw{160}{0}{\includegraphics[height=40mm]{./out/fig/texlive-win-1}}
\end{layer}
\begin{enumerate}
...
\begin{layer}{180}{0}
    \putnotesw{160}{35}{\includegraphics[width=60mm]{./out/fig/texlive-mac-1}}
\end{layer}
\begin{enumerate}
...
\subsubsection{Windowsを使用している場合}
\begin{layer}{180}{0}
    \putnotesw{160}{5}{\includegraphics[height=40mm]{./out/fig/kettex-1}}
\end{layer}
\begin{enumerate}
...
\begin{table}[h]
    ...
    \begin{tabular}{c||l}
        ...
        \textbf{Cinderella}  & \url{https://cinderella.de/}\\
...
\begin{layer}{180}{0}
    \putnotesw{160}{5}{\includegraphics[width=65mm]{./out/fig/cinderella-1}}
\end{layer}
\begin{enumerate}
    \item 表\ref{tab:download}のURLにアクセスする
...
\begin{layer}{180}{0}
    \putnotesw{160}{5}{\includegraphics[height=25mm]{./out/fig/maxima-win-1}}
\end{layer}
\begin{enumerate}
    \item 表\ref{tab:download}のURLにアクセスする
...
\begin{layer}{180}{0}
    \putnotenw{160}{25}{\includegraphics[width=50mm]{./out/fig/c-win-1}}
\end{layer}
\begin{enumerate}
    \item 表\ref{tab:download}のURLにアクセスする
...
\begin{enumerate}
    ...
    \item 右ペインから ダウンロード を選択する
    \item beta.cinderella.deを選択する
    \item Mac OS X disk image (universal)を選択する
